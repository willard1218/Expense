...
- (void)setupDefalutCategory {
  for (TransactionType type = TransactionTypeNone + 1;
       type < TransactionTypeCount; type++) {
...
- (BOOL)application:(UIApplication *)application
  ...
  NSLog(@"%d %d", [[Constants getCategoryTypes:TransactionTypeIncome] count],
        [[Constants getCategoryTypes:TransactionTypeOutcome] count]);
